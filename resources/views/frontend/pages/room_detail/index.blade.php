...
{{--                    </a>--}}
            ...
            <div class="post-bottom-bar">
                <a class="item call" rel="nofollow" href="tel:{{ $author->phone }}"><i class="fa fa-phone" aria-hidden="true"></i> $author->phone</a>
                <a class="item zalo" rel="nofollow" href="https://zalo.me/{{ $author->phone }}">Zalo</a>
                <a class="item sms" rel="nofollow" href="sms:{{ $author->phone }}">Nhắn tin</a>
            </div>
        </div>
